...
vet:
	...
	@go tool vet -atomic -bool -copylocks -nilfunc -printf -shadow -rangeloops -unreachable -unsafeptr -unusedresult nestStructure.go utils.go
...
cyclo:
	@echo "Running $@"
	@${GOPATH}/bin/gocyclo -over 100 nestStructure.go
